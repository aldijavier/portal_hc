...
<body>
	<div class="row">
		<div class="container">
			<h2 class="text-center my-5">Detail Data</h2>
			...
			<div class="col-lg-3 mx-auto my-4">	
				<form action="/upload/proses" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
						<b>Nama Depan</b>
						<input class="form-control" name="nama_depan" type="text" value="{{ $peg->nama_depan }}" disabled required >
                    </div>
                    
                    <div class="form-group">
						<b>Nama Belakang</b>
						<input class="form-control" name="nama_belakang" type="text" value="{{ $peg->nama_belakang }}" disabled required>
					</div>
                    ...
                    <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                            <b>KTP</b><br/>
                           <!-- <input type="file" name="file_ktp" value="{{ $peg->file_ktp }}"> -->
                            <button btn btn-success><a href="/data_file/{{ $peg->file_ktp }}" target="_blank" rel="noopener noreferrer">Lihat KTP</a></button>
                        </div>
