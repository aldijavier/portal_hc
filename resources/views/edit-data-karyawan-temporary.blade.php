  ...
  <div class="content-wrapper bg-white">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
          <h1 class="m-0">Edit Data Karyawan Temporary</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <button class="btn bg-gradient-success"><li class="breadcrumb-item"><a href="{{ route('data-karyawan-temporary')}}" style="color:white">Kembali Data Karyawan Temporary</a></li></button>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
  ...
  <div class="col-md-6">
    <div class="card card-default">
      ...
      <div class="card-body">
                ...
                <div class="form-group">
                    <b>COA</b>
                    <input class="form-control" name="int_emp_coa" type="text" value="{{ $karyawans->int_emp_coa }}" required>
                </div>
                ...
                <div class="form-row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <b>Bank Swift</b>
                            <input class="form-control" name="int_emp_bankswift" type="text" value="{{ $karyawans->int_emp_bankswift }}" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
